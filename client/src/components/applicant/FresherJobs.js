...
import { startDeleteCompany } from '../../actions/companyAction'
...
function FresherJob(props){
    ...
    const filter = (e) => {
        ...
        var skills = displayCompany.filter(skill => skill.requiredSkills.toString().toUpperCase().includes((data).toUpperCase()))
        ...
        swal({
          ...
          .then((willDelete) => {
            if (willDelete) {
              ...
              props.dispatch(startDeleteCompany(id)) 
            } 
          })
    }
